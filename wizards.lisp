;; Wizard's Adventure
;; Um adventure em modo texto feito em Lisp :D
;; Cap 5 do Land of Lisp.

;; Variáveis que controlam o jogo
(defparameter *location* 'living-room) ;;Começa o jogo na sala.
...
(defun drop (object)
	(cond ((member object
		...
		`(you dropped the ,object on the floor))

	      (t '(you cannot drop it here.))))
...
(defun tweak-text (lst caps lit)
	...
	(let ((item (car lst))
        ...
        (cond ((eq item #\space) (cons item (tweak-text rest caps lit)))
	      ...
	      (lit (cons item (tweak-text reast nil lit)))
